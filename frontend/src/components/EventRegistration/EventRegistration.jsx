...
const EventRegistration = () => {
    ...
    const OPTIONS = [
        { value: "", label: "" },
        {
            value: "React: From First Steps to Professional",
            label: "React: From First Steps to Professional",
        },
        {
            value: "A Tour of React Design Patterns",
            label: "A Tour of React Design Patterns",
        },
        { value: "Web Components", label: "Web Components" },
        {
            value: "Build a Fullstack App from Scratch with Flask and React",
            label: "Build a Fullstack App from Scratch with Flask and React",
        },
    ];
